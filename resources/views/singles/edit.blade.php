...
@section('edit')
    <div class="container text-center">
        <h4 class="mt-3">Modifica un Single</h4>
        <form class="my-3" action="{{ route('singles.update', $single) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3 d-flex justify-content-center align-items-center">
                ...
                <input type="text" class="form-control form-input-space" name="name" value="{{ $single['name'] }}"
            ...
            <div class="mb-3 d-flex justify-content-center align-items-center">
                ...
                @if ($single['image'])
                    <img class="img-thumbnail img-custom" src="{{ asset('storage/' . $single['image']) }}"
            ...
            {{-- @foreach ($technologies as $technology)
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="{{ $technology['id'] }}" id="checkDefault"
                        name="technologies[]" {{ $single->technologies->contains($technology['id']) ? 'checked' : '' }}>
