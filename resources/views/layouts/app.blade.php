                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-custom"
                                    ...
                                    <a class="dropdown-item" href="{{ url('albums') }}">{{ __('Albums') }}</a>
                                    <a class="dropdown-item" href="{{ url('eps') }}">{{ __('Eps') }}</a>
                                    <a class="dropdown-item" href="{{ url('singles') }}">{{ __('Singles') }}</a>
                                    <a class="dropdown-item" href="{{ url('genres') }}">{{ __('Genres') }}</a>
